...
describe("asset xcm tests", () => {
    const assetV4: VersionedAsset = { V4: { id: { parents: 0, interior: 'Here' }, fun: { Fungible: 1000 } } };
    const assetInteriorV4: VersionedAsset = { V4: { id: { parents: 1, interior: { X1: [{ Parachain: 200 }] } }, fun: { Fungible: 1000 } } };
    const assetWithMultipleInteriorsV4: VersionedAsset = { V4: { id: { parents: 3, interior: { X2: [{ Parachain: 200 }, { AccountId32: { id: "TEST" } }] } }, fun: { Fungible: 1000 } } };

    const assetV3: VersionedAsset = { V3: { id: { Concrete: { parents: 0, interior: 'Here' } }, fun: { Fungible: 1000 } } }
    const assetInteriorV3: VersionedAsset = { V3: { id: { Concrete: { parents: 1, interior: { X1: { Parachain: 200 } } } }, fun: { Fungible: 1000 } } }
    const assetWithMultipleInteriorsV3: VersionedAsset = { V3: { id: { Concrete: { parents: 3, interior: { X2: [{ Parachain: 200 }, { AccountId32: { id: "TEST" } }] } } }, fun: { Fungible: 1000 } } }

    const assetV2: VersionedAsset = { V2: { id: { Concrete: { parents: 0, interior: 'Here' } }, fun: { Fungible: 1000 } } }
    const assetInteriorV2: VersionedAsset = { V2: { id: { Concrete: { parents: 1, interior: { X1: { Parachain: 200 } } } }, fun: { Fungible: 1000 } } }
    const assetWithMultipleInteriorsV2: VersionedAsset = { V2: { id: { Concrete: { parents: 3, interior: { X2: [{ Parachain: 200 }, { AccountId32: { id: "TEST" } }] } } }, fun: { Fungible: 1000 } } }

    describe("create versions from assets", () => {

        it('create v4 from v4 asset', () => {
            expect(convertAssetVersion(4, assetV4.V4)).toStrictEqual({ V4: asset(location(0, 'Here'), fungible(1000)) });
            expect(convertAssetVersion(4, assetInteriorV4.V4)).toStrictEqual({ V4: asset(location(1, [{ Parachain: 200 }]), fungible(1000)) })
            expect(convertAssetVersion(4, assetWithMultipleInteriorsV4.V4)).toStrictEqual({ V4: asset(location(3, [{ Parachain: 200 }, { AccountId32: { id: "TEST" } }]), fungible(1000)) })
        })


        it('create v4 from v4 asset', () => {
            expect(convertAssetVersion(3, assetV4.V4)).toStrictEqual(assetV3);
            expect(convertAssetVersion(3, assetInteriorV4.V4)).toStrictEqual(assetInteriorV3);
            expect(convertAssetVersion(3, assetWithMultipleInteriorsV4.V4)).toStrictEqual(assetWithMultipleInteriorsV3);
        })
    })
    ...
    describe("asset convert v4->v3", () => {
        ...
        it('asset v4->v3 interior', () => {
            expect(convertAssetVersion(3, assetInteriorV4)).toStrictEqual(assetInteriorV3);
        })

        it('asset v4->v3 multiple interior', () => {
            expect(convertAssetVersion(3, assetWithMultipleInteriorsV4)).toStrictEqual(assetWithMultipleInteriorsV3);
        })
    ...
    describe("asset convert v3->v4", () => {
        ...
        it('asset v3->v4 interior', () => {
            expect(convertAssetVersion(4, assetInteriorV3)).toStrictEqual(assetInteriorV4);
        })

        it('asset v3->v4 multiple interior', () => {
            expect(convertAssetVersion(4, assetWithMultipleInteriorsV3)).toStrictEqual(assetWithMultipleInteriorsV4);
        })
    })
    ...
    describe("asset convert v3->v2", () => {
        ...
        it('asset v3->v4 interior', () => {
            expect(convertAssetVersion(2, assetInteriorV3)).toStrictEqual(assetInteriorV2);
        })

        it('asset v3->v4 multiple interior', () => {
            // "network": "Any"
            expect(convertAssetVersion(2, assetWithMultipleInteriorsV3)).not.toStrictEqual(assetWithMultipleInteriorsV2);
        })
    })
})